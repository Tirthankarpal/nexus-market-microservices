...
echo -e ""
echo -e "2. Compile your Spring Boot microservices in the root folder:"
echo -e "   ${BLUE}./mvnw clean package -DskipTests${NC} (compiles and packages all microservices)"
echo -e ""
